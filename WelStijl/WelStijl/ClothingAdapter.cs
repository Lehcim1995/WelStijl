...
namespace WelStijl
{
    class ClothingAdapter : RecyclerView.Adapter
    {
        ...
        {
            new Clothing(Resource.Drawable.Icon, "Icon", 500),
            new Clothing(Resource.Drawable.Icon, "Other Icon", 495),
            new Clothing(Resource.Drawable.Icon, "Same Other Icon", 490),
            new Clothing(Resource.Drawable.Icon, "More Same Other Icon", 495)
        }); 
